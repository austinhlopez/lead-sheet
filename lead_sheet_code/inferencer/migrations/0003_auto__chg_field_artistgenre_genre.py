...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArtistGenre.genre'
        db.alter_column(u'inferencer_artistgenre', 'genre_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inferencer.Genre'], to_field='name', max_length=120))

    def backwards(self, orm):

        # Changing field 'ArtistGenre.genre'
        db.alter_column(u'inferencer_artistgenre', 'genre_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inferencer.Genre'], to_field='name'))
